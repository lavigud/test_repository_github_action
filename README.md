Projet issu de Valtech

https://gitlab.com/design-system-test/style-dictionary

Après avoir cloné le projet

Se mettre en version Node 16 (nvm use 16)


**Commandes à faire dans le dossier style-dictionary (en node 16!)**
...
Pour Packager les tokens pour Storybook Webcomponents

Dans Visual Studio Code installer le projet 'ds-tokens-test' dans le même workspace que Style Dictionary
https://gitlab.loto-quebec.com/gouvernance_frontend/design-system-exp/ds-tokens-test

**Commandes à faire dans le dossier style-dictionary (en node 16!)**
* npm run build-copy

Automatiquement les tokens vont se copier après le build 
dans le répertoire tokens de ds-tokens-test

Il suffit ensuite de faire un commit sur ce répertoire pour livrer 
un package NPM des tokens.
